...
<body>
	...
	<div id="MainArea">
		<!-- 表单内容 -->
		<form
			action="${pageContext.servletContext.contextPath}/type?method=doUpdate"
			method="post">

			<!-- 本段标题（分段标题） -->
			<div class="ItemBlock_Title">
				<img width="4" height="7" border="0"
					src="../style/images/item_point.gif"> 菜系信息&nbsp;
			</div>
			<!-- 本段表单字段 -->
					...
					<div class="ItemBlock2">
						<table cellpadding="0" cellspacing="0" class="mainForm">
							<tr>
								...
								<td><input type="text" name="typeName" class="InputStyle"
									value="${type.typeName }" /> * <input type="hidden" name="id"
									value="${type.id }" /></td>
							</tr>
						</table>
					</div>
