...
<body>
	...
	<div id="StatusBar">
		...
		<div id="StatusBar_Links">
			<a href="https://www.baidu.com" target="_blank">百度一下</a>，你就知道！
		</div>
		<!-- 右侧功能按钮 -->
		<div id="StatusBar_Right">
			...
			<a href="javascript:void(0)"> <img border="0" width="11"
				height="11"
				src="${pageContext.servletContext.contextPath}/sys/style/images/info.gif" />
				<img border="0" width="40" height="11"
				src="${pageContext.servletContext.contextPath}/sys/style/images/version.gif" />
			</a>
		</div>
	</div>
