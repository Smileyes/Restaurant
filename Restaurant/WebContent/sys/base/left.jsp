...
#Menu .level1 .level1Style {
	background:
		url("../sys/style/images/img/menu_btn_bg.gif")
...
#Menu .level1 .MenuLevel2 .level2Style {
	...
	width: 112px;
	background-image:
		url("../sys/style/images/img/menu_arrow_single.gif");
	...
	<ul id="Menu">
		<li class="level1">
			<div onClick="menuClick(this);" class="level1Style">
				<img
					src="${pageContext.servletContext.contextPath}/sys/style/images/func20001.gif"
					class="Icon" /> 系统菜单
			</div>
			<ul class="MenuLevel2">
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.servletContext.contextPath}/table?method=tableList">餐桌管理</a></li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.servletContext.contextPath}/type?method=typeList">菜系管理</a></li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.servletContext.contextPath}/food?method=foodList">菜品管理</a></li>
				<li class="level2 level2Style"><a target="right"
					href="${pageContext.servletContext.contextPath}/order?method=orderList">餐厅订单</a></li>
			</ul>
		</li>
	</ul>
</body>
